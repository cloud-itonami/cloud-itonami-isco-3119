(ns engineering.advisor
  "EngineeringAdvisor — proposes a lab operation (run a test protocol on a
  sample, log a result, flag an out-of-spec result, calibrate equipment) for a
  ...
  provenance or analytical integrity risk; `engineering.governor` is the
...
(def ^:private system-prompt
  "You are a lab technician advisor for physical and engineering science
